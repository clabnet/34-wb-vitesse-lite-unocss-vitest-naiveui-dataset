...
<template>
  <div>
    <h1>DevExtreme TreeList</h1>
    <a
      href="https://js.devexpress.com/Demos/WidgetsGallery/Demo/TreeList/Overview/Vue/MaterialTealLight/Compact/">Documentation</a>
    ...
    <DxTreeList id="employees"
      ...
      <DxColumn data-field="Head_ID"
        caption="Head">
        <DxLookup :data-source="dataSource"
          value-expr="ID"
